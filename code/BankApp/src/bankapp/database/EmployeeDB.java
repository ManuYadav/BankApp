...
public class EmployeeDB extends DBConnection {
	...
	public EmployeeDB() throws Exception {
	  ...
	  public boolean addCustomer(CustomerDetails customerDetails) {
		  ...
		  String sqlAddCustomerString = "INSERT INTO customer(pass, lname, fname, address, city, phone, email, best_time) VALUES(?, ?, ?, ?, ?, ?, ?, ?)";
	  ...
	  public boolean createAccountForCustomer(int customerId, int employeeId, int accountType, float specVariable) {
		  ...
		  if (accountType == 0) { sqlCreateSpecificAccountForCustomerString = "INSERT INTO savings VALUES(?, ?)"; }
		  else { sqlCreateSpecificAccountForCustomerString = "INSERT INTO checking VALUES(?, ?)"; }
